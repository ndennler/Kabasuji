...
public class CoverUpLevelGUI extends JFrame implements ILevelGUI{
	 ...
	 * Create the frame.
	 */
	public CoverUpLevelGUI(CoverUpLevel level, Kabasuji game) {
		this.game = game;
		...
		btnRotateCC.setIcon(new ImageIcon(CoverUpLevelGUI.class.getResource("/com/sun/javafx/scene/web/skin/Undo_16x16_JFX.png")));
		...
		btnFlipH.setIcon(new ImageIcon(CoverUpLevelGUI.class.getResource("/images/flipHorizontal.png")));
		...
		btnRotateC.setIcon(new ImageIcon(CoverUpLevelGUI.class.getResource("/com/sun/javafx/scene/web/skin/Redo_16x16_JFX.png")));
		...
		btnFlipV.setIcon(new ImageIcon(CoverUpLevelGUI.class.getResource("/images/flipVertical.png")));
		...
		lblNewLabel.setIcon(new ImageIcon(CoverUpLevelGUI.class.getResource("/images/ThreeStars.png")));
		lblNewLabel.setBounds(400, 130, 74, 19);
		contentPane.add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("New label");
		lblNewLabel_1.setIcon(new ImageIcon(CoverUpLevelGUI.class.getResource("/images/TwoStars.png")));
		lblNewLabel_1.setBounds(400, 185, 74, 19);
		contentPane.add(lblNewLabel_1);
		
		JLabel lblNewLabel_2 = new JLabel("");
		lblNewLabel_2.setIcon(new ImageIcon(CoverUpLevelGUI.class.getResource("/images/OneStar.png")));
		...
		JLabel lblYellows = new JLabel("lblYellowsCoveredows Covered:");
		lblYellows.setFont(new Font("Constantia", Font.PLAIN, 10));
		lblYellows.setBounds(379, 311, 95, 10);
		contentPane.add(lblYellows);
		...
		JLabel lblYellowsCovered = new JLabel(level.getYellowText());
		lblYellowsCovered.setForeground(new Color(220, 20, 60));
		lblYellowsCovered.setBackground(new Color(220, 20, 60));
		lblYellowsCovered.setFont(new Font("Constantia", Font.PLAIN, 10));
		lblYellowsCovered.setBounds(379, 322, 95, 10);
		contentPane.add(lblYellowsCovered);
	...
	public void restore(LevelMemento level) {
		CoverUpLevel l = new CoverUpLevel();
		l.restore(level);
		new CoverUpLevelGUI(l, game).setVisible(true);
		this.dispose();
	}
